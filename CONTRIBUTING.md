# Welcome to H>E>R>M>E>S contributing guide

Thank you for contribute to our project! 

In this guide we will stablish the contribution workflow from opening an issue, creating a PR, reviewing, and merging the PR.
...
- PR will only be merged if it passes review by the yakuteam.
...
If you found a problem, [search if an issue already exists](https://docs.github.com/en/github/searching-for-information-on-github/searching-on-github/searching-issues-and-pull-requests#search-by-the-title-body-or-comments). If a related issue doesn't exist, you can open a new issue using a relevant [issue form](https://github.com/lisardowo/HERMES/issues/new/choose). 

#### Solve an issue

Scan through our [existing issues](https://github.com/lisardowo/HERMES/issues) to find one that interests you.
...
Once you submit your PR, a yakucode team member will review your proposal. We may ask questions or request for additional information.
...
**At yakucode we are grateful for your help!**